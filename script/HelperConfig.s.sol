...
contract HelperConfig is Script {
    ...
    int256 public constant INITIAL_PRICE = 2000000000000000000;
    ...
    function getOrCreateAnvilEthConfig() public returns (NetworkConfig memory) {
        ...
        vm.startBroadcast();
        MockV3Aggregator mocks = new MockV3Aggregator(DECIMALS, INITIAL_PRICE);
        vm.stopBroadcast();
        NetworkConfig memory networkConfig = NetworkConfig({priceFeed: address(mocks)});
        return networkConfig;
    }
}
